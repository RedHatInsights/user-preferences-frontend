 ...
 * that expose a severity grid use the severity subscription table UI. When it is
 * off, the legacy checkbox layout is used; the notifications API should not ship
 * grid-only event payloads unless this flag is on (or the UI cannot render those
 * event types).
 */
